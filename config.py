...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5874143832:AAGLt3JzOY7gWmFgCBSFh_FKMdwbPnY500Q")

# API ID Anda dari my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "22131867"))
...
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001622016385"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5046623167").split())]
except ValueError:
